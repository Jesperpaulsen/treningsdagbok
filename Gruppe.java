...
//Metoder
    ...
    public Gruppe(Connection n) {
     ...
     public void lagOvelsesGruppe(Scanner s)  throws SQLException{
    ...
    public int GruppeID_DB(Connection conn){
        String query = "SELECT ovelsesGruppeId FROM ovelsesGruppe ORDER BY ovelsesGruppeId DESC LIMIT 1";
        try {
